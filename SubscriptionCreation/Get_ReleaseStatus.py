...
BUILD_ID = 7457
REPOSITORY_ID = "b18e1d14-4276-4b41-b4e0-193000f45566"
REPOSITORY_NAME = "azglz_pipeline_createsub"
SUBSCRIPTION_NAME = "sub-snsvc0005219-poc-std-991"
...
def main(req: func.HttpRequest) -> func.HttpResponse:
    ...
    env_id = release_id + 7
    approval_id = release_id + 311
    deployment_id = release_id + 10
    deploy_step_id = release_id + 312
    phase_id = release_id + 8
    run_plan_id = str(uuid.uuid4())

    now = _iso_now()
    release_name = f"Release-{max(1, release_id - 112)}"
    ...
    response = {
        ...
        "body": {
            ...
            "variables": {"subscription_name": {"value": SUBSCRIPTION_NAME, "allowOverride": True}},
            "variableGroups": [],
            "artifacts": [
                {
                    "sourceId": f"{PROJECT_ID}:{BUILD_DEF_ID}",
                    "type": "Build",
                    "alias": "_CI_azglz_pipeline_createsub-nonprod",
                    "definitionReference": {
                        ...
                        "sourceVersion": {"id": "8765499308289460b1b0de176c9c5e86789", "name": None},
            ...
            "releaseDefinitionRevision": 5,
            "description": f"NonProd- Create new release for {SUBSCRIPTION_NAME}",
